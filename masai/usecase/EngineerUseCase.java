...
public class EngineerUseCase {
	...
	public static void getEngineerOptions(Engineer eng) {
		...
		if(c==1) {
			...
			System.out.println("==========================");
			List<Complain> complist = eng.getCompsOfYou(eng);
			...
			String res = eng.updateCompStatus(compid,status, eng);
			System.out.println(res);
			
		}else if(c==3) {
			System.out.println("Get Your All Assigned Complain History ");
			List<Complain> complist = eng.getCompHistory(eng);
			...
			String res = eng.changePass(newPass, eng);
			System.out.println(res);
		}
		else if(c==5) {
